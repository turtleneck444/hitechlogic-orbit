...
const partnerIcons = [
  { label: "Accenture", icon: Building2 },
  { label: "Northwind Cloud", icon: CloudCog },
  { label: "ShieldOps", icon: ShieldCheck },
  { label: "CircuitAI", icon: CircuitBoard },
  { label: "Global Grid", icon: Globe2 },
  { label: "Skyline Systems", icon: Server },
  { label: "StatusNet", icon: Network },
  { label: "BlueEdge", icon: CloudCog },
];
          ...
          <div className="relative pt-24">
              ...
              <div className="sm:mx-auto lg:mr-auto">
                ...
                >
                  <h1 className="mt-8 max-w-2xl text-balance text-5xl font-medium md:text-6xl lg:mt-16">
                    Build and ship 10x faster with HiTechLogic NS
                  </h1>
                  <p className="mt-8 max-w-2xl text-pretty text-lg text-silver/70">
                    Tailwind CSS-powered, executive-grade components for modern applications designed to operate reliably
                    at enterprise scale.
                  </p>
            ...
            >
              <div className="relative -mr-56 mt-8 overflow-hidden px-2 sm:mr-0 sm:mt-12 md:mt-20">
                ...
                <div className="relative mx-auto max-w-5xl overflow-hidden rounded-2xl border border-white/10 bg-background p-4 shadow-lg shadow-zinc-950/15 ring-1 ring-background/40">
                  <img
                    className="aspect-[15/8] rounded-2xl object-cover object-center"
                    src="https://images.unsplash.com/photo-1521737604893-d14cc237f11d?auto=format&fit=crop&w=2700&q=80"
        ...
        <section className="bg-background pb-16 pt-16 md:pb-32">
          <div className="group relative m-auto max-w-5xl px-6">
            <div className="absolute inset-0 z-10 flex scale-95 items-center justify-center opacity-0 duration-500 group-hover:scale-100 group-hover:opacity-100">
              <Link to="/case-studies" className="block text-sm duration-150 hover:opacity-75">
            ...
            <div className="group-hover:blur-xs mx-auto mt-12 grid max-w-2xl grid-cols-2 gap-x-12 gap-y-8 transition-all duration-500 group-hover:opacity-50 sm:grid-cols-4 sm:gap-x-16 sm:gap-y-14">
              {partnerIcons.map(({ label, icon: Icon }) => (
                <div key={label} className="flex items-center justify-center text-silver/70">
    ...
    <header>
      <nav
        ...
        className={cn(
          ...
          scrolled ? "bg-background/60 backdrop-blur-3xl" : "bg-transparent",
        )}
      >
        <div className="mx-auto max-w-5xl px-6 transition-all duration-300">
          <div className="relative flex flex-wrap items-center justify-between gap-6 py-3 lg:gap-0 lg:py-4">
            ...
            <div className="group-data-[state=active]:block lg:group-data-[state=active]:flex mb-6 hidden w-full flex-wrap items-center justify-end space-y-8 rounded-3xl border border-white/10 bg-background p-6 shadow-2xl shadow-zinc-300/20 transition md:flex-nowrap lg:m-0 lg:flex lg:w-fit lg:gap-6 lg:space-y-0 lg:border-transparent lg:bg-transparent lg:p-0 lg:shadow-none dark:shadow-none">
...
const Logo = ({ className }: { className?: string }) => {
  return (
    <svg viewBox="0 0 78 18" fill="none" xmlns="http://www.w3.org/2000/svg" className={cn("h-5 w-auto text-electric-blue", className)}>
      <path
