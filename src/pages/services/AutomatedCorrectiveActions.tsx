      ...
      <section className="relative overflow-hidden bg-gradient-to-br from-white via-emerald-50/20 to-blue-50/30">
        ...
        <div className="relative mx-auto w-full max-w-6xl px-6 pt-32 pb-20 sm:pt-40 sm:pb-28">
          <div className="flex items-center gap-3 mb-6 animate-[fade-in_0.5s_ease-out]">
            <div className="flex h-14 w-14 items-center justify-center rounded-2xl bg-gradient-to-br from-emerald-500 to-[hsl(var(--navy))] shadow-lg shadow-emerald-500/25 transition-transform duration-300 hover:scale-110">
              <Workflow className="h-7 w-7 text-white" />
            </div>
            <span className="eyebrow text-emerald-600">Automated Corrective Actions & Stabilization Workflows</span>
          </div>
          <h1 className="mt-6 text-5xl md:text-6xl lg:text-7xl font-bold leading-tight text-[hsl(var(--navy))] animate-[fade-in_0.6s_ease-out_0.1s_both]">
            ...
            <span className="text-emerald-600">Zero Toil</span>
          </h1>
          <p className="mt-6 text-xl text-slate-600 max-w-3xl leading-relaxed animate-[fade-in_0.7s_ease-out_0.2s_both]">
            Codified runbooks and intelligent automation workflows that resolve 70% of incidents automatically,
            reduce MTTR to minutes, and eliminate repetitive manual work.
          </p>

          <div className="mt-10 flex flex-wrap gap-4 animate-[fade-in_0.8s_ease-out_0.3s_both]">
            <Button variant="hero" size="xl" asChild className="shadow-[0_20px_45px_-20px_rgba(16,185,129,0.8)] hover:shadow-[0_25px_50px_-12px_rgba(16,185,129,0.9)] hover:scale-105 transition-all duration-300">
            ...
            <Button variant="outline" size="xl" asChild className="hover:bg-slate-50 transition-all duration-300">
              <Link to="/contact" className="flex items-center gap-2 group">
                ...
                <span>Talk to Automation Expert</span>
              </Link>
            </Button>
          </div>
            ...
            {metrics.map((metric) => (
              <div key={metric.label} className="text-center group">
                <div className="flex justify-center mb-3">
                  <div className="flex h-12 w-12 items-center justify-center rounded-xl bg-gradient-to-br from-emerald-500/10 to-emerald-600/5 group-hover:from-emerald-500/20 group-hover:to-emerald-600/10 transition-all duration-300">
                    <metric.icon className="h-6 w-6 text-emerald-600" />
                  </div>
                </div>
                <div className="text-3xl md:text-4xl font-bold text-emerald-600 group-hover:scale-110 transition-transform duration-300">{metric.value}</div>
