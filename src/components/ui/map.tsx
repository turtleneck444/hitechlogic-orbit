...
export function WorldMap({
  ...
  const svgMap = useMemo(
    () => map.getSVG({
      radius: 0.22,
      color: "#00000020", // Light theme focused, subtle dots
      shape: "circle",
  ...
  return (
    <div className="w-full h-full dark:bg-black bg-white rounded-lg relative font-sans overflow-hidden">
      <img
      ...
      <svg
        ref={svgRef}
        viewBox="0 0 800 400"
        className="w-full h-full absolute inset-0 pointer-events-auto select-none opacity-40"
