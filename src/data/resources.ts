...
export const resources: Resource[] = [
  ...
  },
  {
    ...
    title: "Enterprise Compliance Certification in 90 Days: A Practical Roadmap",
    description: "Accelerated path to enterprise compliance certification. Covers gap analysis, control implementation, evidence collection, and audit preparation based on successful certifications achieved in record time.",
    category: "webinar",
    author: "Compliance Practice",
    date: "2024-12-10",
    readTime: "45 min",
    tags: ["Enterprise Compliance", "Compliance", "Security", "Audit"],
    featured: false,
